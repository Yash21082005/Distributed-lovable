...
import com.codingshuttle.distributed_lovable.common_lib.security.FeignAuthTokenContext;
...
//    private final ProjectFileService projectFileService;
    ...
    public Flux<ChatClientResponse> adviseStream(ChatClientRequest request, StreamAdvisorChain streamAdvisorChain) {
      ...
      ChatClientRequest augmentedChatClientRequest=augmentRequestWithFileTree(request,projectId,authToken);

      return streamAdvisorChain.nextStream(augmentedChatClientRequest);
    }

    private ChatClientRequest augmentRequestWithFileTree(ChatClientRequest request, Long projectId, String authToken){
      ...
      List<FileNode> fileTree = FeignAuthTokenContext.withToken(authToken, () -> workspaceClient.getFileTree(projectId)).files();
